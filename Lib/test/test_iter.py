...
class TestCase(unittest.TestCase):
    ...
    def test_iter_basic(self):
        self.check_iterator(iter(list(range(10))), list(range(10)))
    ...
    def test_iter_for_loop(self):
        self.check_for_loop(iter(list(range(10))), list(range(10)))
    ...
    def test_iter_big_range(self):
        self.check_for_loop(iter(list(range(10000))), list(range(10000)))
    ...
    def test_builtin_list(self):
        ...
        self.assertEqual(list(range(10, -1, -1)), list(range(10, -1, -1)))
    ...
    def test_builtin_filter(self):
        self.assertEqual([_f for _f in SequenceClass(5) if _f], list(range(1, 5)))
        self.assertEqual([_f for _f in SequenceClass(0) if _f], [])
        self.assertEqual([_f for _f in () if _f], ())
        self.assertEqual([_f for _f in "abc" if _f], "abc")

        d = {"one": 1, "two": 2, "three": 3}
        self.assertEqual([_f for _f in d if _f], list(d.keys()))
        ...
        self.assertEqual([x for x in seq if not x], [bFalse]*25)
        self.assertEqual([x for x in iter(seq) if not x], [bFalse]*25)
    ...
    def test_builtin_zip(self):
        ...
        self.assertRaises(TypeError, zip, list(range(10)), 42)
        self.assertRaises(TypeError, zip, list(range(10)), zip)
        ...
        d = {"one": 1, "two": 2, "three": 3}
        self.assertEqual(list(d.items()), list(zip(d, iter(d.values()))))
        ...
        self.assertEqual(list(zip(list(range(5)))), [(i,) for i in range(5)])
        ...
        self.assertEqual(list(zip(NoGuessLen5())), list(zip(list(range(5)))))
        self.assertEqual(list(zip(Guess3Len5())), list(zip(list(range(5)))))
        self.assertEqual(list(zip(Guess30Len5())), list(zip(list(range(5)))))

        expected = [(i, i) for i in range(5)]
        for x in NoGuessLen5(), Guess3Len5(), Guess30Len5():
            for y in NoGuessLen5(), Guess3Len5(), Guess30Len5():
                self.assertEqual(list(zip(x, y)), expected)
    ...
    def _test_builtin_reduce(self):
        ...
        d = {"one": 1, "two": 2, "three": 3}
        self.assertEqual(reduce(add, d), "".join(list(d.keys())))
    ...
    def test_in_and_not_in(self):
        ...
        for k in d:
            ...
            self.assertTrue(k not in iter(d.values()))
        for v in list(d.values()):
            self.assertTrue(v in iter(d.values()))
            self.assertTrue(v not in d)
        for k, v in d.items():
            self.assertTrue((k, v) in iter(d.items()))
            self.assertTrue((v, k) not in iter(d.items()))
    ...
    def test_countOf(self):
        ...
        self.assertEqual(countOf(iter(d.values()), 3), 3)
        self.assertEqual(countOf(iter(d.values()), 2j), 1)
        self.assertEqual(countOf(iter(d.values()), 1j), 0)
    ...
    def test_unpack_iter(self):
        ...
        a, b, c = iter({1: 42, 2: 42, 3: 42}.values())
    ...
    def test_sinkstate_dict(self):
        ...
        for b in iter(a), iter(a.keys()), iter(a.items()), iter(a.values()):
            b = iter(a)
    ...
    def test_sinkstate_enumerate(self):
        ...
        e = enumerate(a)
        b = iter(e)
        self.assertEqual(list(b), list(zip(list(range(5)), list(range(5)))))
        self.assertEqual(list(b), [])
