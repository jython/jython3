...
class TestCompile(unittest.TestCase):
    ...
    def test_alias_trim(self):
        ...
        self.assertEqual(node.body[0].names[0].name, "os.path")
    ...
    def test_cmpop(self):
        ...
        compare = expr.body
        self.assertTrue(isinstance(compare.ops[0], ast.Lt))
        self.assertTrue(isinstance(compare.comparators[0], ast.Name))
        self.assertTrue(isinstance(compare.ops[1], ast.Lt))
        self.assertTrue(isinstance(compare.comparators[1], ast.Name))
        self.assertTrue(isinstance(compare.ops[1:][0], ast.Lt))
        self.assertTrue(isinstance(compare.comparators[1:][0], ast.Name))
        z = list(zip( compare.ops[1:], compare.comparators[1:]))
        self.assertTrue(isinstance(z[0][0], ast.Lt))
        self.assertTrue(isinstance(z[0][1], ast.Name))
