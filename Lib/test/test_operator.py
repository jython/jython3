...
class OperatorTestCase(unittest.TestCase):
    ...
    def test_isMappingType(self):
        ...
        self.assertFalse(isinstance(1, collections.Mapping))
        self.assertFalse(isinstance(operator.isMappingType, collections.Mapping))
        self.assertTrue(isinstance(operator.__dict__, collections.Mapping))
        self.assertTrue(isinstance({}, collections.Mapping))
    ...
    def test_isSequenceType(self):
        ...
        self.assertTrue(isinstance(dir(), collections.Sequence))
        self.assertTrue(isinstance((), collections.Sequence))
        self.assertTrue(isinstance(list(range(10)), collections.Sequence))
        self.assertTrue(isinstance('yeahbuddy', collections.Sequence))
        self.assertFalse(isinstance(3, collections.Sequence))
        class Dict(dict): pass
        self.assertFalse(isinstance(Dict(), collections.Sequence))
