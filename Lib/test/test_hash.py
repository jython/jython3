...
class HashEqualityTestCase(unittest.TestCase):
    ...
    def test_coerced_integers(self):
        self.same_hash(int(1), int(1), float(1), complex(1),
                       int('1'), float('1.0'))
        self.same_hash(int(-2**31), int(-2**31), float(-2**31))
        self.same_hash(int(1-2**31), int(1-2**31), float(1-2**31))
        self.same_hash(int(2**31-1), int(2**31-1), float(2**31-1))
        # for 64-bit platforms
        self.same_hash(int(2**31), int(2**31), float(2**31))
        self.same_hash(int(-2**63), int(-2**63), float(-2**63))
        self.same_hash(int(1-2**63), int(1-2**63))
        self.same_hash(int(2**63-1), int(2**63-1))
