...
class UnicodeFunctionsTest(UnicodeDatabaseTest):
    ...
    def test_digit(self):
        ...
        self.assertEqual(self.db.digit('\u2468', None), None)  # CIRCLED DIGIT NINE is not a digit
    ...
    def test_decimal(self):
        ...
        self.assertEqual(self.db.decimal('\u2468'), 9)  # CIRCLED DIGIT NINE is a decimal
    ...
    def test_bidirectional(self):
        self.assertEqual(self.db.bidirectional('\uFFFE'), 'BN')  # CORRECTED according to ICU4J
