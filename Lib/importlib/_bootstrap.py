...
class _ModuleLock:
    ...
    def __init__(self, name):
        _thread = getattr(sys.modules[__name__], "_thread")
...
def _get_module_lock(name):
    ...
    if lock is None:
        ...
        _weakref = getattr(sys.modules[__name__], "_weakref")
...
def _verbose_message(message, *args, verbosity=100):
