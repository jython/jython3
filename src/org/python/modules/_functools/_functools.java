...
public class _functools implements ClassDictInit {
    ...
    public static final PyBytes __doc__ = new PyBytes("Tools that operate on functions.");

    public static void classDictInit(PyObject dict) {
        dict.__setitem__("__name__", new PyBytes("_functools"));
    ...
    public static PyBytes __doc__reduce = new PyBytes(
