...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -Wl,-O1,--sort-common,--as-needed,-z,relro '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -Wstrict-prototypes -march=x86-64 -mtune=generic '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O1,--sort-common,--as-needed,-z,relro',
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-threads' "
                "'--with-computed-gotos' '--enable-ipv6' '--with-system-expat' "
 ...
 'COVERAGE_INFO': '/build/python/src/Python-3.5.1/coverage.info',
 'COVERAGE_REPORT': '/build/python/src/Python-3.5.1/lcov-report',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-O1,--sort-common,--as-needed,-z,relro '
             '-Wl,-O1,--sort-common,--as-needed,-z,relro',
 'LDVERSION': '3.5m',
 'LIBC': '',
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -Wstrict-prototypes -march=x86-64 '
              '-mtune=generic -O2 -pipe -fstack-protector-strong -march=x86-64 '
              '-mtune=generic -O2 -pipe -fstack-protector-strong -march=x86-64 '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-fstack-protector-strong -march=x86-64 -mtune=generic -O2 '
                   '-pipe -fstack-protector-strong -march=x86-64 '
                   '-mtune=generic -O2 -pipe -fstack-protector-strong '
                   '-Werror=declaration-after-statement -I. -IInclude '
                   '-I./Include -D_FORTIFY_SOURCE=2 -D_FORTIFY_SOURCE=2 -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -IInclude -I./Include -D_FORTIFY_SOURCE=2 '
                '-D_FORTIFY_SOURCE=2',
 'PY_FORMAT_LONG_LONG': '"ll"',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-O1,--sort-common,--as-needed,-z,relro '
               '-Wl,-O1,--sort-common,--as-needed,-z,relro',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 'Py_HASH_ALGORITHM': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python/src/Python-3.5.1',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python/src/Python-3.5.1 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python/src/Python-3.5.1 ./python '
 ...
 'abs_builddir': '/build/python/src/Python-3.5.1',
 'abs_srcdir': '/build/python/src/Python-3.5.1',
